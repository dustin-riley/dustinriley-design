...
| Base element resets (link underline, boxed code, heading sizes, body) — internally `@layer base`, imported uniformly by every app; components/prose always win over it | `@dustin-riley/design/reset.css` |
